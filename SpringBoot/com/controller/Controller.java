...
public class Controller {
	...
	@PostMapping("/addEmp")//http://localhost:1801/emp/addEmp
	public String insertEmp(@RequestBody Employee emp) {
		return service.addEmp(emp);
	}
	@PutMapping("/updateEmp")//http/localhost:1801/emp/addEmp
	public String updateEmp(@RequestBody Employee emp) {
		return service.updateEmp(emp);
	}

	@DeleteMapping("/deleteEmp/{eid}")//http/localhost:1801/emp/addEmp
	public String deleteEmp(@PathVariable("eid") int empId  ) {
		return service.deleteEmp(empId);
	}
	@GetMapping("/getEmp/{eid}")//http/localhost:1801/emp/addEmp
